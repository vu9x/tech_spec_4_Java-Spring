...
public class LoggableAspect {
    @Pointcut("within(@ru.gb.springbootseminar8.Loggable *)")
    public void beansMethod(){}

    @Pointcut("@annotation(ru.gb.springbootseminar8.Loggable)")
...
//        System.out.println("target: " + proceedingJoinPoint.getTarget());
